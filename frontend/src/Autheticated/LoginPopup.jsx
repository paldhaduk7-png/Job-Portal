...
import { LogIn, Home, Shield, Zap, User, Sparkles, UserPlus } from "lucide-react"
...
const LoginPopup = ({ open, setOpen }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-md overflow-hidden p-0 gap-0 bg-gradient-to-br from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 border border-slate-200/80 shadow-2xl">
        ...
        <div className="relative bg-gradient-to-r from-purple-600 via-indigo-600 to-pink-600 p-6 pb-7 text-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-purple-100 text-sm mt-0.5">
                  Sign in or create a free account to unlock all listings
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 dark:from-purple-950/30 dark:to-purple-900/20 rounded-xl p-3 text-center group hover:scale-105 transition-transform">
                <User className="h-5 w-5 text-purple-600 dark:text-purple-400 mx-auto mb-1.5" />
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-indigo-100/50 dark:from-indigo-950/30 dark:to-indigo-900/20 rounded-xl p-3 text-center group hover:scale-105 transition-transform">
                <Sparkles className="h-5 w-5 text-indigo-600 dark:text-indigo-400 mx-auto mb-1.5" />
                <p className="text-[11px] font-medium text-slate-700 dark:text-slate-300 leading-tight">Apply</p>
                <p className="text-[10px] text-slate-500 dark:text-slate-400">Instantly</p>
              </div>
              <div className="bg-gradient-to-br from-pink-50 to-pink-100/50 dark:from-pink-950/30 dark:to-pink-900/20 rounded-xl p-3 text-center group hover:scale-105 transition-transform">
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400">All Jobs</p>
              </div>
            </div>
            ...
            <div className="bg-slate-50/80 dark:bg-slate-800/30 rounded-xl p-4 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
              <ul className="space-y-2">
                <li className="flex items-start gap-3 text-sm">
                  ...
                  <span className="text-slate-700 dark:text-slate-300">View unlimited verified job opportunities</span>
                </li>
                <li className="flex items-start gap-3 text-sm">
                  <div className="mt-0.5 h-5 w-5 rounded-full bg-indigo-500/10 flex items-center justify-center flex-shrink-0">
                    <div className="h-1.5 w-1.5 rounded-full bg-indigo-600" />
                  </div>
                  <span className="text-slate-700 dark:text-slate-300">Save jobs & track your submitted applications</span>
                </li>
                <li className="flex items-start gap-3 text-sm">
                  ...
                  <span className="text-slate-700 dark:text-slate-300">100% free with no hidden subscriptions</span>
                </li>
              </ul>
            </div>
            ...
            <p className="text-xs text-center text-slate-500">
              ...
              >
                <UserPlus className="w-3 h-3 inline" /> Create free account
              </button>
            </p>
          </div>
        </div>
        ...
        <div className="relative p-6 pt-0 flex flex-col-reverse sm:flex-row justify-end gap-3">
          ...
          <Button 
            ...
            className="gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white shadow-lg shadow-purple-600/25 hover:shadow-purple-600/40 transition-all duration-300 flex-1 sm:flex-none"
            size="default"
          >
