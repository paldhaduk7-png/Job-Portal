...
import { Loader2, ArrowLeft, Briefcase, MapPin, FileText, List, DollarSign, Users, Clock, Building2, AlertCircle } from 'lucide-react'
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="bg-white/85 backdrop-blur-xl rounded-3xl shadow-2xl shadow-orange-500/10 border border-white/90 overflow-hidden transition-all duration-300">
          ...
          <form onSubmit={submitHandler} className="p-8">
            ...
            {allCompany.length === 0 && (
              <div className="mb-6 p-4 bg-red-50/90 border border-red-200 rounded-2xl flex items-start gap-3">
                <AlertCircle className="h-5 w-5 text-red-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-sm font-semibold text-red-700">No Company Registered</p>
                  <p className="text-sm text-red-600 mt-0.5">
                    Please register a company first before posting a job.
                    <button
                      type="button"
                      onClick={() => navigate("/admin/comapanies/create")}
                      className="ml-2 text-red-700 font-semibold underline hover:text-red-800"
                    >
                      Create Company
                    </button>
                  </p>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <Select onValueChange={selectChangeHandler}>
                      <SelectTrigger className="pl-10 h-11 bg-slate-50/70 border-slate-200/80 focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 rounded-xl transition-all duration-200">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-end gap-3">
              ...
              <Button
                type="submit"
                disabled={loading || allCompany.length === 0}
